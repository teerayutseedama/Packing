...
namespace Packing.Function
{
    ...
    public class SummaryInterface : ISummaryInterface
    {
        ...
        public SummaryInterface(vms_packingContext context) {
        ...
        public async Task<IEnumerable<SummaryDataView>> GetSummaryList(GetSummaryDataView data)
        {
            ...
            Expression<Func<tbm_plant_move2stored, bool>> plantConds = PredicateBuilder.New<tbm_plant_move2stored>(true);
            ...
            var list =await (from nh in _context.tbt_pk_batch_no_header.Where(batchConds)
                             from pl in _context.tbm_plant_move2stored.Where(plantConds)
            ...
            foreach (var item in group)
            {
                ...
                view.MFGDate = item.Key.MFGDate;
                view.ExpireDate = item.Key.ExpireDate;
